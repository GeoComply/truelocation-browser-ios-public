...
open class UserAgent {
    ...
    public static let currentBrowserVersion = "IOSTrueLocationBrowser/\(Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") ?? "1.10")"
    ...
    public static var syncUserAgent: String {
        return clientUserAgent(prefix: "GeoComply-iOS-Sync")
    }

    public static var tokenServerClientUserAgent: String {
        return clientUserAgent(prefix: "GeoComply-iOS-Token")
    }

    public static var fxaUserAgent: String {
        return clientUserAgent(prefix: "GeoComply-iOS-FxA")
    }

    public static var defaultClientUserAgent: String {
        return clientUserAgent(prefix: "GeoComply-iOS")
    }
