...
public enum AppName: String, CustomStringConvertible {
    case shortName = "TrueLocation Browser"
    case longName = "TrueLocation Browser Daylight"
...
public struct AppConstants {
    ...
    // GG Overriden
    /// Did show request "Always Allow" for Location permission
    public static let PrefDidRequestAlwayLocation = "settings.didRequestAlwayLocation"
}
