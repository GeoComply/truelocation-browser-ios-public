...
extension Strings {
    ...
    // Overriden
    public static let FirefoxHomePage = NSLocalizedString("Firefox.HomePage.Title", value: "TrueLocation Browser Home Page", comment: "Title for firefox about:home page in tab history list")
}
...
extension String {
    ...
    public struct KeyboardShortcuts {
        ...
        public static let NewNormalTab = MZLocalizedString("Keyboard.Shortcuts.NewNormalTab", value: "New Normal Tab", comment: "A label indicating the keyboard shortcut of opening a new non-private tab, switching the user to that tab and Normal Browsing Mode. This label is displayed inside the Discoverability overlay when a user presses the Command key. The Discoverability overlay and shortcut become available only when a user has connected a hardware keyboard to an iPad. See https://drive.google.com/file/d/1gH3tbvDceg7yG5N67NIHS-AXgDgCzBHN/view?usp=sharing for more details.", lastUpdated: .v97)
    ...
    public struct Settings {
        ...
        public struct Homepage {
            ...
            public struct CustomizeFirefoxHome {
                ...
                public static let Description = MZLocalizedString("Settings.Home.Option.Description", value: "Choose content you see on the TrueLocation Browser homepage.", comment: "In the settings menu, on the TrueLocation Browser homepage customization section, this is the description below the section, describing what the options in the section are for.", lastUpdated: .v39)
...
extension String {
    ...
    public static let NewTabSectionNameFooter = MZLocalizedString("Settings.NewTab.TopSectionNameFooter", value: "Choose what to load when opening a new tab", comment: "Footer at the bottom of the New Tab screen after entering New Tab in settings")
    // Overriden
    public static let SettingsNewTabTopSites = NSLocalizedString("Settings.NewTab.Option.FirefoxHome", value: "TrueLocation Browser Home", comment: "Option in settings to show Firefox Home when you open a new tab")
    ...
    // Overriden
        public static let SettingsTopSitesCustomizeTitle = NSLocalizedString("Settings.NewTab.Option.CustomizeTitle", value: "Customize TrueLocation Browser Home", comment: "The title for the section to customize top sites in the new tab settings page.")
    ...
    /*
    public static let NewTabSectionNameFooter = MZLocalizedString("Settings.NewTab.TopSectionNameFooter", value: "Choose what to load when opening a new tab", comment: "Footer at the bottom of the New Tab screen after entering New Tab in settings", lastUpdated: .unknown)
...
extension Strings {
    ...
    public static let SettingsOfferClipboardBarStatus = MZLocalizedString("Settings.OfferClipboardBar.Status", value: "When Opening TrueLocation Browser", comment: "Description displayed under the ”Offer to Open Copied Link” option. See https://bug1223660.bmoattachments.org/attachment.cgi?id=8898349")
}
...
// MARK: - MR1 Strings
extension String {
    public static let MenuHelperSearchWithBrowser = MZLocalizedString("UIMenuItem.SearchWithBrowser", value: "Search with Browser", comment: "Search in New Tab Text selection menu item")
...
extension String {
    ...
    public static let SettingsCustomizeHomeTitle = MZLocalizedString("Settings.Home.Option.Title", value: "TrueLocation Browser Homepage", comment: "In the settings menu, this is the title of the TrueLocation Browser Homepage customization settings section", lastUpdated: .v39)
