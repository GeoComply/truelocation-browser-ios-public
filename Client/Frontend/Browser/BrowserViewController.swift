...
extension BrowserViewController: TabDelegate {
    ...
    func tab(_ tab: Tab, didCreateWebView webView: WKWebView) {
        ...
        tab.addContentScript(geolocateHelper, name: GeolocateHelper.name())
        
        let geoguardHelper = GeoGuardHelper(tab: tab)
        tab.addContentScript(geoguardHelper, name: GeoGuardHelper.name())
...
//            self.firefoxHomeViewController?.dismissDefaultBrowserCard()
    ...
    private func introVCPresentHelper(introViewController: UIViewController) {
        ...
        if topTabsVisible {
            ...
            introViewController.modalPresentationStyle = .overFullScreen
        } else {
