...
open class MenuHelper: NSObject {
    ...
    public static let SelectorSearchWithBrowser: Selector = #selector(MenuHelperInterface.menuHelperSearchWithBrowser)
    ...
    open func setItems() {
        ...
        let searchItem = UIMenuItem(title: .MenuHelperSearchWithBrowser, action: MenuHelper.SelectorSearchWithBrowser)
